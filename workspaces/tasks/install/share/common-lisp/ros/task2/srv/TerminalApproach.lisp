...
(cl:defclass <TerminalApproach-request> (roslisp-msg-protocol:ros-message)
  ((feedback
    :reader feedback
    :initarg :feedback
    :type task2-msg:TerminalApproachFeedback
    :initform (cl:make-instance 'task2-msg:TerminalApproachFeedback)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <TerminalApproach-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TerminalApproach-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name task2-srv:<TerminalApproach-request> is deprecated: use task2-srv:TerminalApproach-request instead.")))

(cl:ensure-generic-function 'feedback-val :lambda-list '(m))
(cl:defmethod feedback-val ((m <TerminalApproach-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task2-srv:feedback-val is deprecated.  Use task2-srv:feedback instead.")
  (feedback m))
...
(cl:defmethod cl:initialize-instance :after ((m <TerminalApproach-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TerminalApproach-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name task2-srv:<TerminalApproach-response> is deprecated: use task2-srv:TerminalApproach-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TerminalApproach-response>)))
  ...
  "task2/TerminalApproachResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TerminalApproach-response)))
  "Returns string type for a service object of type 'TerminalApproach-response"
  "task2/TerminalApproachResponse")
