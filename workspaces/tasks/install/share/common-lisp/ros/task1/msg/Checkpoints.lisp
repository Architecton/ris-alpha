...
(cl:defmethod cl:initialize-instance :after ((m <Checkpoints>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Checkpoints)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name task1-msg:<Checkpoints> is deprecated: use task1-msg:Checkpoints instead.")))

(cl:ensure-generic-function 'points-val :lambda-list '(m))
(cl:defmethod points-val ((m <Checkpoints>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task1-msg:points-val is deprecated.  Use task1-msg:points instead.")
  (points m))
