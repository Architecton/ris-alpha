...
(cl:defmethod num_of_checkpoints-val ((m <Checkpoint_res-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task1-srv:num_of_checkpoints-val is deprecated.  Use task1-srv:num_of_checkpoints instead.")
