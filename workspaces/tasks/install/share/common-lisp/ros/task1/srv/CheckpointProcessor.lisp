...
(cl:defmethod cl:initialize-instance :after ((m <CheckpointProcessor-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CheckpointProcessor-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name task1-srv:<CheckpointProcessor-request> is deprecated: use task1-srv:CheckpointProcessor-request instead.")))

(cl:ensure-generic-function 'input_x-val :lambda-list '(m))
(cl:defmethod input_x-val ((m <CheckpointProcessor-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task1-srv:input_x-val is deprecated.  Use task1-srv:input_x instead.")
  (input_x m))

(cl:ensure-generic-function 'input_y-val :lambda-list '(m))
(cl:defmethod input_y-val ((m <CheckpointProcessor-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task1-srv:input_y-val is deprecated.  Use task1-srv:input_y instead.")
  (input_y m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CheckpointProcessor-request>)))
  ...
  "task1/CheckpointProcessorRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CheckpointProcessor-request)))
  "Returns string type for a service object of type 'CheckpointProcessor-request"
  "task1/CheckpointProcessorRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <CheckpointProcessor-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CheckpointProcessor-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name task1-srv:<CheckpointProcessor-response> is deprecated: use task1-srv:CheckpointProcessor-response instead.")))

(cl:ensure-generic-function 'output_x-val :lambda-list '(m))
(cl:defmethod output_x-val ((m <CheckpointProcessor-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task1-srv:output_x-val is deprecated.  Use task1-srv:output_x instead.")
  (output_x m))

(cl:ensure-generic-function 'output_y-val :lambda-list '(m))
(cl:defmethod output_y-val ((m <CheckpointProcessor-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task1-srv:output_y-val is deprecated.  Use task1-srv:output_y instead.")
  (output_y m))

(cl:ensure-generic-function 'valid-val :lambda-list '(m))
(cl:defmethod valid-val ((m <CheckpointProcessor-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task1-srv:valid-val is deprecated.  Use task1-srv:valid instead.")
  (valid m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CheckpointProcessor-response>)))
  ...
  "task1/CheckpointProcessorResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CheckpointProcessor-response)))
  "Returns string type for a service object of type 'CheckpointProcessor-response"
  "task1/CheckpointProcessorResponse")
