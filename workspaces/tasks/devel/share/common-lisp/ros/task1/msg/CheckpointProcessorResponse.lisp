...
(cl:defmethod cl:initialize-instance :after ((m <CheckpointProcessorResponse>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CheckpointProcessorResponse)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name task1-msg:<CheckpointProcessorResponse> is deprecated: use task1-msg:CheckpointProcessorResponse instead.")))

(cl:ensure-generic-function 'output_x-val :lambda-list '(m))
(cl:defmethod output_x-val ((m <CheckpointProcessorResponse>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task1-msg:output_x-val is deprecated.  Use task1-msg:output_x instead.")
  (output_x m))

(cl:ensure-generic-function 'output_y-val :lambda-list '(m))
(cl:defmethod output_y-val ((m <CheckpointProcessorResponse>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task1-msg:output_y-val is deprecated.  Use task1-msg:output_y instead.")
  (output_y m))

(cl:ensure-generic-function 'valid-val :lambda-list '(m))
(cl:defmethod valid-val ((m <CheckpointProcessorResponse>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task1-msg:valid-val is deprecated.  Use task1-msg:valid instead.")
  (valid m))
