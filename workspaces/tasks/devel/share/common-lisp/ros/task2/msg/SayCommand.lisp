...
(cl:defmethod cl:initialize-instance :after ((m <SayCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SayCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name task2-msg:<SayCommand> is deprecated: use task2-msg:SayCommand instead.")))

(cl:ensure-generic-function 'text-val :lambda-list '(m))
(cl:defmethod text-val ((m <SayCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task2-msg:text-val is deprecated.  Use task2-msg:text instead.")
  (text m))
