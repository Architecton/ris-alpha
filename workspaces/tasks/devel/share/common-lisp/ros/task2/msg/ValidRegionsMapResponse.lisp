...
(cl:defmethod cl:initialize-instance :after ((m <ValidRegionsMapResponse>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ValidRegionsMapResponse)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name task2-msg:<ValidRegionsMapResponse> is deprecated: use task2-msg:ValidRegionsMapResponse instead.")))
