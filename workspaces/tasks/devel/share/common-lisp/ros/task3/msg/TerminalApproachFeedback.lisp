...
(cl:defmethod cl:initialize-instance :after ((m <TerminalApproachFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TerminalApproachFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name task3-msg:<TerminalApproachFeedback> is deprecated: use task3-msg:TerminalApproachFeedback instead.")))

(cl:ensure-generic-function 'target_center_x-val :lambda-list '(m))
(cl:defmethod target_center_x-val ((m <TerminalApproachFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task3-msg:target_center_x-val is deprecated.  Use task3-msg:target_center_x instead.")
  (target_center_x m))
...
(cl:defmethod window_size-val ((m <TerminalApproachFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task3-msg:window_size-val is deprecated.  Use task3-msg:window_size instead.")
  (window_size m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TerminalApproachFeedback>)))
  ...
  "task3/TerminalApproachFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TerminalApproachFeedback)))
  "Returns string type for a message object of type 'TerminalApproachFeedback"
  "task3/TerminalApproachFeedback")
