...
(cl:defmethod cl:initialize-instance :after ((m <ApproachImageFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ApproachImageFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name task3-msg:<ApproachImageFeedback> is deprecated: use task3-msg:ApproachImageFeedback instead.")))
