...
(cl:defmethod cl:initialize-instance :after ((m <RingApproachPointResponse>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RingApproachPointResponse)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name task3-msg:<RingApproachPointResponse> is deprecated: use task3-msg:RingApproachPointResponse instead.")))
...
(cl:defmethod output_z-val ((m <RingApproachPointResponse>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task3-msg:output_z-val is deprecated.  Use task3-msg:output_z instead.")
  (output_z m))

(cl:ensure-generic-function 'output_w-val :lambda-list '(m))
(cl:defmethod output_w-val ((m <RingApproachPointResponse>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task3-msg:output_w-val is deprecated.  Use task3-msg:output_w instead.")
  (output_w m))
