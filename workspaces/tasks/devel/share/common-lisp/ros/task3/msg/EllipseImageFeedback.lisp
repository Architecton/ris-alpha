...
;//! \htmlinclude EllipseImageFeedback.msg.html

(cl:defclass <EllipseImageFeedback> (roslisp-msg-protocol:ros-message)
  ((timestamp
    :reader timestamp
    :initarg :timestamp
    :type cl:real
...
(cl:defclass EllipseImageFeedback (<EllipseImageFeedback>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <EllipseImageFeedback>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'EllipseImageFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name task3-msg:<EllipseImageFeedback> is deprecated: use task3-msg:EllipseImageFeedback instead.")))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <EllipseImageFeedback>))
...
(cl:defmethod center_x-val ((m <EllipseImageFeedback>))
...
(cl:defmethod center_y-val ((m <EllipseImageFeedback>))
...
(cl:defmethod minor_axis-val ((m <EllipseImageFeedback>))
...
(cl:defmethod major_axis-val ((m <EllipseImageFeedback>))
...
(cl:defmethod dpt-val ((m <EllipseImageFeedback>))
  ...
  (dpt m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <EllipseImageFeedback>) ostream)
  "Serializes a message object of type '<EllipseImageFeedback>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EllipseImageFeedback>) istream)
  "Deserializes a message object of type '<EllipseImageFeedback>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<EllipseImageFeedback>)))
  "Returns string type for a message object of type '<EllipseImageFeedback>"
  "task3/EllipseImageFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'EllipseImageFeedback)))
  "Returns string type for a message object of type 'EllipseImageFeedback"
  "task3/EllipseImageFeedback")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<EllipseImageFeedback>)))
  "Returns md5sum for a message object of type '<EllipseImageFeedback>"
  "48f6d07ab2de708512ad475e0ac59310")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'EllipseImageFeedback)))
  "Returns md5sum for a message object of type 'EllipseImageFeedback"
  "48f6d07ab2de708512ad475e0ac59310")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EllipseImageFeedback>)))
  "Returns full string definition for message of type '<EllipseImageFeedback>"
  (cl:format cl:nil "time timestamp~%int32 center_x~%int32 center_y~%int32 minor_axis~%int32 major_axis~%float32 dpt~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EllipseImageFeedback)))
  "Returns full string definition for message of type 'EllipseImageFeedback"
  (cl:format cl:nil "time timestamp~%int32 center_x~%int32 center_y~%int32 minor_axis~%int32 major_axis~%float32 dpt~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <EllipseImageFeedback>))
  (cl:+ 0
     8
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <EllipseImageFeedback>))
  "Converts a ROS message object to a list"
  (cl:list 'EllipseImageFeedback
