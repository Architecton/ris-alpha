...
(cl:defmethod cl:initialize-instance :after ((m <ScanFlag>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ScanFlag)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name task3-msg:<ScanFlag> is deprecated: use task3-msg:ScanFlag instead.")))

(cl:ensure-generic-function 'flag-val :lambda-list '(m))
(cl:defmethod flag-val ((m <ScanFlag>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task3-msg:flag-val is deprecated.  Use task3-msg:flag instead.")
  (flag m))
