...
(cl:defmethod cl:initialize-instance :after ((m <ValidRegionsMap-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ValidRegionsMap-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name task3-srv:<ValidRegionsMap-request> is deprecated: use task3-srv:ValidRegionsMap-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <ValidRegionsMap-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ValidRegionsMap-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name task3-srv:<ValidRegionsMap-response> is deprecated: use task3-srv:ValidRegionsMap-response instead.")))
