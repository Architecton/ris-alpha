...
(cl:defmethod cl:initialize-instance :after ((m <EllipseLocator-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EllipseLocator-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name task3-srv:<EllipseLocator-request> is deprecated: use task3-srv:EllipseLocator-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <EllipseLocator-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EllipseLocator-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name task3-srv:<EllipseLocator-response> is deprecated: use task3-srv:EllipseLocator-response instead.")))
