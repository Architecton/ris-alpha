...
(cl:defmethod cl:initialize-instance :after ((m <FeatureBuilder-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FeatureBuilder-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name task3-srv:<FeatureBuilder-request> is deprecated: use task3-srv:FeatureBuilder-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <FeatureBuilder-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FeatureBuilder-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name task3-srv:<FeatureBuilder-response> is deprecated: use task3-srv:FeatureBuilder-response instead.")))
