...
class EllipseImageFeedback {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new EllipseImageFeedback(null);
  ...
  static datatype() {
    ...
    return 'task3/EllipseImageFeedback';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new EllipseImageFeedback(null);
...
module.exports = EllipseImageFeedback;
