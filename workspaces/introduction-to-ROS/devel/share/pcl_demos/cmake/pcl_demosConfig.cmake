...
if("TRUE" STREQUAL "TRUE")
  set(pcl_demos_SOURCE_PREFIX /home/dkalsan/ris-alpha/workspaces/introduction-to-ROS/src/exercise7)
  set(pcl_demos_DEVEL_PREFIX /home/dkalsan/ris-alpha/workspaces/introduction-to-ROS/devel)
  ...
  set(pcl_demos_INSTALL_PREFIX /home/dkalsan/ris-alpha/workspaces/introduction-to-ROS/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pcl_demos' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'pcl_demos' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dkalsan/ris-alpha/workspaces/introduction-to-ROS/src/exercise7/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${pcl_demos_dep}_FOUND)
      find_package(${pcl_demos_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${pcl_demos_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
